import {
    Table, Column, Model, DataType, PrimaryKey, Default, ForeignKey, HasMany, BelongsTo
...
export class MessageTemplate extends Model<MessageTemplate, TemplateCreationAttrs> {
    @PrimaryKey
